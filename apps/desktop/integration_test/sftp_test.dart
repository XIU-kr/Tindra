...
void main() {
  ...
  test(
    'SFTP round-trip: open → list → upload → download → cleanup',
    () async {
      ...
      final localDownload = File(
        '${Directory.systemTemp.path}/$marker.down.txt',
      );
      ...
      expect(
        entries.any((e) => e.name == '$marker.txt'),
        isTrue,
      ...
      expect(
        entriesAfter.any((e) => e.name == '$marker.txt'),
        isFalse,
